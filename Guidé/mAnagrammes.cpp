...
//     CHECK((listeDesAnagrammesDuDico("rien", Dico) == set<string>{"rien",
//     "nier", "rein"}));
//     //  afficheListedeMots(
//     listeDesAnagrammesDuDico("rien","dictionnaire.txt"));
...
//     CHECK((retire("brossent", "sorbet") == "ns") or (retire("brossent",
//     "sorbet") == "sn"));
