                                    ...
                                    string joueur)
{
    ...
    cout << joueur << " ------>Veuillez choisir une action parmis celle possibles:" << endl;
...
{
    cout << nomJoueur << ", veuillez taper les trois lettres de votre vrac dont vous souhaitez vous débarasser:";
}

void afficheLaDemandeDeTaperUnMot(string nomJoueur)
{
    cout << nomJoueur << ", veuillez taper votre nouveau mot ou seulement la lettre P pour passer votre tour:";
}
...
{
    cout << "... " << mot << " ... ----------> Ce mot entre les points de suspension est non valide " << endl;
}

void signaleGagnant(string nomJoueur)
{
    cout << "Bravo, " << nomJoueur << " remporte la partie et a gagné un sourire! " << endl;
}
