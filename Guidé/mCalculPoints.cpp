...
//     CHECK(calculPoints({"essai", "tentative", "mots", "affichable"}, 12, 6) == 197);
//     CHECK(calculPoints({"essai", "recursivement", "enumerable"}, 12, 6) == 100);
//     CHECK(calculPoints({"essai", "tentative", "mots", "affichable"}, 15, 3) == 197);
//     CHECK(calculPoints({"essai", "tentative", "mots", "affichable"}, 15, 1) == 81);
//     CHECK(calculPoints({"abcdefghijklmnopqrstuvwxyz", "affichable"}, 10, 8) == 100);
//     CHECK(calculPoints({"abcdefghijklmnopqrstuvwxyz", "trop", "de", "mots"}, 20, 2) == 16);
//     CHECK(calculPoints({"abcdefghijklmnopqrstuvwxyz", "mots", "trop", "long", "oui"}, 3, 10) == 9);
// }
